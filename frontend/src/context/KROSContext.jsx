...
export const SKILLS_DATA = [
  ...
  // AI Analysis skills
  { id: "ops_ai_analysis",   module: "ai",    title: "AI Operations Analysis",             owner: "Ops Superintendent",      status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "medium", description: "AI-driven production analysis, anomaly detection, fault prediction and optimisation recommendations." },
  { id: "hse_ai_analysis",   module: "ai",    title: "AI Safety Analysis",                 owner: "HSE Manager",             status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "medium", description: "AI incident pattern analysis, safety risk prediction and proactive hazard recommendations." },
  { id: "hrm_ai_analysis",   module: "ai",    title: "AI HR Analytics",                    owner: "HR Manager",              status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "high",   description: "AI workforce analytics, attrition prediction, competency gap detection and training recommendations." },
  { id: "fin_ai_analysis",   module: "ai",    title: "AI Financial Analysis",              owner: "Finance Manager",         status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "high",   description: "AI budget variance analysis, anomaly detection, cost optimisation and cash flow recommendations." },
  { id: "maint_ai_analysis", module: "ai",    title: "AI Maintenance Analysis",            owner: "Maintenance Super.",      status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "low",    description: "AI predictive maintenance, fault detection and diagnosis, PM schedule optimisation." },
  { id: "env_ai_analysis",   module: "ai",    title: "AI Environmental Analysis",          owner: "Environmental Manager",   status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "medium", description: "AI environmental monitoring, compliance risk prediction and remediation recommendations." },
  { id: "proj_ai_analysis",  module: "ai",    title: "AI Project Analysis",                owner: "General Manager / PMO",   status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "medium", description: "AI schedule slippage detection, cost performance analysis, risk detection and resource optimisation." },
  // Quality module
  { id: "qa_inspection",     module: "qa",    title: "Quality Inspection Procedures",      owner: "Quality Manager",         status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "low",    description: "Inspection procedures across mining and processing value chain with sampling protocols and acceptance criteria." },
  { id: "qa_lab_testing",    module: "qa",    title: "Laboratory Testing Procedures",      owner: "Laboratory Manager",      status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "low",    description: "Standard methods for on-site lab testing of ore, concentrate and aggregate with QC protocols." },
  // Logistics module
  { id: "log_inventory",     module: "log",   title: "Inventory Management",               owner: "Logistics Manager",       status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "low",    description: "Consumables and spare parts inventory management, ABC classification, stocktake procedures." },
  { id: "log_transport",     module: "log",   title: "Transport & Logistics",              owner: "Logistics Manager",       status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "low",    description: "Product dispatch, haulage management, export logistics and contractor coordination." },
  // Energy module
  { id: "eng_power_mgmt",    module: "eng",   title: "Power Management",                   owner: "Engineering Manager",     status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "low",    description: "Power consumption monitoring, generator management, fuel tracking and energy cost control." },
  { id: "eng_optimization",  module: "eng",   title: "Energy Optimisation",                owner: "Engineering Manager",     status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "low",    description: "Energy auditing, load optimisation, equipment efficiency and alternative energy strategies." },
  // Community module
  { id: "com_relations",     module: "com",   title: "Community Relations",                owner: "Community Relations Mgr", status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "medium", description: "Stakeholder engagement, consultation procedures, CSR programme and grievance management." },
  { id: "com_complaints",    module: "com",   title: "Community Complaints & Feedback",     owner: "Community Relations Mgr", status: "fresh",  lastUpdated: "2025-05-27", sensitivity: "medium", description: "Complaint channels, classification, investigation procedures and escalation process." },
];
